      ...
      body: SafeArea(
        child: Container(
          margin: EdgeInsets.symmetric(
              horizontal: size.width > 600 ? size.width * 0.12 : 2),
          decoration: BoxDecoration(
            ...
            children: [
              Card(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      image(50, '${AppController.baseImageUrl}/logo.png',
                          pad: 2),
                      SizedBox(width: 10),
                      Expanded(
                        child: Column(
              ...
              value(
                  staff.responsibilities ?? 'none!', TablerIcons.list_details),
