...
class _NoticeScreenState extends ConsumerState<NoticeScreen> {
          ...
          data: (snap) {
            ...
            Widget data = Container(
              margin: EdgeInsets.symmetric(
                horizontal: size.width < 500 ? 0 : size.width * 0.12,
              ),
            ...
            return size.width < 500 ? data : Center(child: data);
          },
          error: (error, _) {
            return Center(child: Text('Something went wrong'));
          },
          loading: () => size.width < 500
              ? loading(size, isDark)
              : Center(child: loading(size, isDark)),
        ),
      ),
  ...
  Widget loading(Size size, bool isDark) => Container(
      margin: EdgeInsets.symmetric(
        horizontal: size.width < 500 ? 0 : size.width * 0.12,
      ),
      decoration: BoxDecoration(
      ...
      child: NoticeShimmer(isDark: isDark));
}
